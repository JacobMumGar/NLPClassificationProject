...
def loadData():
    #!!!! REPLACE FILE PATH BELOW WITH THE PATH TO YOUR LOCAL SPEECHES DATA FOLDER BEFORE RUNNING !!!!
    path = "/home/jacob/Documents/Uni/Scc453/Project/NLPClassificationProject/data/speeches"
    ...
    #there was an empty file so exception handling to deal with that
    speeches = []
